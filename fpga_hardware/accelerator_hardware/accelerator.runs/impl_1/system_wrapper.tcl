namespace eval ::optrace {
  variable script "F:/accelerator/accelerator.runs/impl_1/system_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir F:/accelerator/accelerator.cache/wt [current_project]
