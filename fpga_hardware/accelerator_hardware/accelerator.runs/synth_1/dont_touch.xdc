...
# IP: bd/system/ip/system_matmul_accel_0_0/system_matmul_accel_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_matmul_accel_0_0 || ORIG_REF_NAME==system_matmul_accel_0_0} -quiet] -quiet

# XDC: f:/accelerator/accelerator.gen/sources_1/bd/system/system_ooc.xdc
